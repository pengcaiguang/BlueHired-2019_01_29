...
@property(nonatomic,strong)NSString *date;//当前时间
@property(nonatomic,strong)NSString *overtimeHours;//加班小时数
@property(nonatomic,strong)NSString *leaveHours;//请假小时数
@property(nonatomic,strong)NSString *accountMoney;//消费金额
@property(nonatomic,strong)NSString *remark;// 备注
@property(nonatomic,strong)NSString *shift;//班次
