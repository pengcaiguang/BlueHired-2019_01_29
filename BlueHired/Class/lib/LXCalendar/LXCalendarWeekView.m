...
-(void)setWeekTitles:(NSArray *)weekTitles{
    ...
    for (int i = 0; i< weekTitles.count; i++) {
        UILabel *weekLabel =[UILabel LXLabelWithText:weekTitles[i] textColor:[UIColor colorWithHexString:@"#929292"] backgroundColor:[UIColor whiteColor] frame:CGRectMake(i * width, 0, width, self.lx_height) font:Font(13) textAlignment:NSTextAlignmentCenter];
