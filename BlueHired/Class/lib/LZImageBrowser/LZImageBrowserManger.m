...
//    imageBrowserViewController.modalTransitionStyle = UIModalTransitionStyleFlipHorizontal;
    imageBrowserViewController.modalPresentationStyle = UIModalPresentationOverCurrentContext;
 
    [appdelegate.window.rootViewController presentViewController:imageBrowserViewController  animated:YES completion:nil];
    
    
    
//    [self.controller presentViewController:imageBrowserViewController animated:YES completion:nil];
//    imageBrowserViewController.hidesBottomBarWhenPushed = YES;
//    CATransition *transition = [CATransition animation];
//    transition.duration = 1.0f;
//    transition.timingFunction = [CAMediaTimingFunction functionWithName:kCAMediaTimingFunctionEaseInEaseOut];
//    transition.type = kCATransitionFade;
//    transition.subtype = kCATransitionFromRight;
//    transition.delegate = self.controller;
//    [self.controller.navigationController.view.layer addAnimation:transition forKey:nil];
    
    
//    [self.controller.navigationController pushViewController:imageBrowserViewController animated:YES];
 }
- (void)initForceTouch {
