...
@class LPAssistantDataModel;

@interface LPAssistantModel : NSObject
@property (nonatomic, copy) NSNumber *code;
@property (nonatomic, copy) NSArray <LPAssistantDataModel *> *data;
@property (nonatomic, copy) NSString *msg;

@end
@interface LPAssistantDataModel : NSObject
