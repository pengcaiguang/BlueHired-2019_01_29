...
static NSString *LPWinningResutltsCellID = @"LPWinningResutltsCell";

@interface LPWinningResultsVC ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation LPWinningResultsVC
...
- (UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    LPWinningResutltsCell *cell = [tableView dequeueReusableCellWithIdentifier:LPWinningResutltsCellID];
...
- (UITableView *)tableview{
    if (!_tableview) {
        ...
        [_tableview registerNib:[UINib nibWithNibName:LPWinningResutltsCellID bundle:nil] forCellReuseIdentifier:LPWinningResutltsCellID];
